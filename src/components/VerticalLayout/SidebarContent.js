          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/dashboard">{props.t("Overview")}</Link>
                </li>
                <li>
                  <Link to="/dashboard-saas">{props.t("Analytics")}</Link>
                </li>
                <li>
                  <Link to="/dashboard-crypto">{props.t("Events")}</Link>
                </li>
                {/* <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/ecommerce-products">{props.t("SETUP")}</Link>
                </li>
                <li>
            ...
            <li>
              <Link to="/#" className="has-arrow ">
                ...
                <span>{props.t("NETWORK")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/crypto-wallet">{props.t("MONITOR")}</Link>
                </li>
                {/* <li>
                  <Link to="/crypto-buy-sell">{props.t("Buy/Sell")}</Link>
                </li> */}
                <li>
                  <Link to="/crypto-exchange">{props.t("NETWORK")}</Link>
                </li>
                {/* <li>
                  <Link to="/crypto-lending">{props.t("Lending")}</Link>
                </li> */}
                <li>
                  <Link to="/crypto-orders">{props.t("MODULES")}</Link>
                </li>
                {/* <li>
